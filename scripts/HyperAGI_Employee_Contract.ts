...
async function main() {
  ...
  const contract = await ethers.getContractFactory('HyperAGI_Employee_Contract')
  ...
  await (await instance.setContractAddress([HyperAGI_Storage.target, '0x7B33C8D43C52d0c575eACaEcFdAd68487bfB28Ea', '0x7f5Ca488c623d4DA355fb1307c41809EE3dC7ADD'])).wait()
